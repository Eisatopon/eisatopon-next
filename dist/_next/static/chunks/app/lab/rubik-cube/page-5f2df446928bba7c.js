(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[9746],{4373:(e,r,t)=>{Promise.resolve().then(t.bind(t,9990))},9990:(e,r,t)=>{"use strict";t.r(r),t.d(r,{default:()=>b});var n=t(5155),o=t(2115);let a=["R","L","U","D","F","B"],i=["","'","2"],s={R:"x",L:"x",U:"y",D:"y",F:"z",B:"z"};function l(e){return new Promise((r,t)=>{if(document.querySelector(`script[src="${e}"]`))return void r();let n=document.createElement("script");n.src=e,n.async=!0,n.onload=()=>r(),n.onerror=()=>t(Error("Failed: "+e)),document.head.appendChild(n)})}function d(e){return(e||"").replace(/\s+/g," ").trim()}function c(e=20){let r=[],t="";for(;r.length<e;){let e=a[Math.floor(Math.random()*a.length)],n=s[e];n!==t&&(r.push(e+i[Math.floor(Math.random()*i.length)]),t=n)}return r.join(" ")}async function p(e){if(navigator.clipboard?.writeText)return void await navigator.clipboard.writeText(e);let r=document.createElement("input");r.style.cssText="position:fixed;opacity:0;top:0;left:0",r.value=e,document.body.appendChild(r),r.focus(),r.select(),r.setSelectionRange(0,e.length);let t=document.execCommand("copy");if(document.body.removeChild(r),!t)throw Error("execCommand failed")}let x=[{key:"R",label:"Right",color:"#ef4444"},{key:"L",label:"Left",color:"#3b82f6"},{key:"U",label:"Up",color:"#fbbf24"},{key:"D",label:"Down",color:"#f97316"},{key:"F",label:"Front",color:"#10b981"},{key:"B",label:"Back",color:"#a78bfa"}];function b(){let e=(0,o.useRef)(null),r=(0,o.useRef)(!1),[t,a]=(0,o.useState)(""),[i,s]=(0,o.useState)(null),[b,g]=(0,o.useState)(""),[u,k]=(0,o.useState)(!0),[m,h]=(0,o.useState)(!1),[f,v]=(0,o.useState)(!1),[y,j]=(0,o.useState)("engine"),[w,N]=(0,o.useState)(!1),C=(0,o.useCallback)((r,t="")=>{let n=e.current;if(!n||"function"!=typeof window.AnimCube3)return;for(;n.firstChild;)n.removeChild(n.firstChild);let o=document.createElement("div");o.style.cssText="width:100%;height:100%",n.appendChild(o);let a=`initmove=${encodeURIComponent(r)}&move=${encodeURIComponent(t)}&initrevmove=#`,i=document.createElement("script");i.text=`AnimCube3('${("edit=1&snap=1&speed=10&bgcolor=ffffff&cubecolor=000000&buttonbar=0&hint=0&movetext=1&textsize=12&position=lluu&"+a).replace(/'/g,"\\'")}')`,o.appendChild(i)},[]);(0,o.useEffect)(()=>{let e=!1;return(async()=>{try{if(j("engine"),await l("https://animcubejs.cubing.net/AnimCube3.js"),e||(j("solver"),await l("https://unpkg.com/cubejs/lib/cube.js"),await l("https://unpkg.com/cubejs/lib/solve.js"),e))return;r.current=!1,j(null),h(!0),k(!1)}catch(r){e||(g("Load error: "+(r instanceof Error?r.message:r)),k(!1),j(null))}})(),()=>{e=!0}},[]),(0,o.useEffect)(()=>{if(!m)return;let e=c();a(e),C(e,"")},[m,C]),(0,o.useEffect)(()=>()=>{let r=e.current;if(r)for(;r.firstChild;)r.removeChild(r.firstChild)},[]);let z=()=>{s(null),g(""),C(d(t),"")},S=async()=>{if(!i)return void g("Press Solve first.");try{await p(i),v(!0),g(""),setTimeout(()=>v(!1),2e3)}catch{g("Copy failed – please select manually.")}};return(0,n.jsxs)("div",{className:"rk-root",children:[(0,n.jsxs)("div",{className:"rk-bg",children:[(0,n.jsx)("div",{className:"rk-orb rk-orb1"}),(0,n.jsx)("div",{className:"rk-orb rk-orb2"}),(0,n.jsx)("div",{className:"rk-orb rk-orb3"})]}),(0,n.jsxs)("header",{className:"rk-header",children:[(0,n.jsxs)("div",{className:"rk-header-left",children:[(0,n.jsxs)("a",{href:"/",className:"rk-back",children:[(0,n.jsx)("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",children:(0,n.jsx)("path",{d:"M19 12H5M12 5l-7 7 7 7"})}),(0,n.jsx)("span",{children:"EisatoponAI"})]}),(0,n.jsxs)("div",{className:"rk-brand",children:[(0,n.jsx)("div",{className:"rk-cube-icon",children:(0,n.jsx)("span",{children:"⬛"})}),(0,n.jsxs)("div",{children:[(0,n.jsxs)("h1",{className:"rk-title",children:["Rubik's Cube",(0,n.jsx)("br",{}),(0,n.jsx)("span",{className:"rk-title-accent",children:"Solver"})]}),(0,n.jsx)("p",{className:"rk-sub",children:"Interactive 3D \xb7 WCA Notation \xb7 Optimal Solution"})]})]})]}),y&&(0,n.jsxs)("div",{className:"rk-loading-pill",children:[(0,n.jsx)("div",{className:"rk-spinner"}),(0,n.jsx)("span",{children:"engine"===y?"Loading 3D engine…":"Loading solver…"})]}),!y&&(0,n.jsxs)("div",{className:"rk-controls",children:[(0,n.jsx)("input",{className:"rk-input",value:t,onChange:e=>a(e.target.value),onKeyDown:e=>"Enter"===e.key&&z(),placeholder:"R U R' U' F2 …",spellCheck:!1,autoComplete:"off",disabled:u}),(0,n.jsxs)("div",{className:"rk-btns",children:[(0,n.jsx)("button",{onClick:()=>{let e=c();a(e),s(null),g(""),C(e,"")},disabled:u,className:"rk-btn rk-btn-ghost",children:"Random"}),(0,n.jsx)("button",{onClick:z,disabled:u,className:"rk-btn rk-btn-teal",children:"Scramble"}),(0,n.jsx)("button",{onClick:()=>{let e=d(t);e&&(k(!0),g("Computing solution…"),setTimeout(()=>{try{r.current||(window.Cube.initSolver(),r.current=!0);let t=new window.Cube;t.move(e);let n=t.solve();s(n),C(e,n),g("")}catch(e){s("Invalid scramble – use standard WCA notation.\n\n"+e),g("Invalid scramble.")}finally{k(!1)}},50))},disabled:u,className:"rk-btn rk-btn-primary",children:"Solve →"}),(0,n.jsx)("button",{onClick:()=>{let e=c();a(e),s(null),g(""),C(e,"")},disabled:u,className:"rk-btn rk-btn-ghost",children:"Reset"})]})]})]}),(0,n.jsxs)("div",{className:"rk-grid",children:[(0,n.jsxs)("section",{className:"rk-panel rk-cube-panel",children:[(0,n.jsx)("div",{className:"rk-panel-label",children:"3D Viewer"}),(0,n.jsx)("div",{ref:e,className:"rk-cube","aria-label":"Interactive 3D Rubik's Cube"}),(0,n.jsx)("p",{className:"rk-tip",children:"Drag to rotate \xb7 Scroll to zoom"})]}),(0,n.jsxs)("div",{className:"rk-right",children:[(0,n.jsxs)("section",{className:"rk-panel rk-sol-panel",children:[(0,n.jsxs)("div",{className:"rk-sol-header",children:[(0,n.jsxs)("div",{children:[(0,n.jsx)("div",{className:"rk-panel-label",children:"Solution Algorithm"}),i&&(0,n.jsxs)("div",{className:"rk-move-count",children:[i.trim().split(/\s+/).length," moves"]})]}),(0,n.jsx)("button",{onClick:S,disabled:!i||u,className:`rk-copy-btn ${f?"rk-copied":""}`,children:f?"✓ Copied!":"Copy"})]}),(0,n.jsx)("pre",{className:"rk-out",children:u?"⏳ Computing…":i||(m?'Press "Solve" to generate an optimal solution.':"Loading…")}),b&&(0,n.jsx)("div",{className:`rk-status ${b.includes("error")||b.includes("Invalid")||b.includes("failed")?"rk-status-err":""}`,children:b})]}),(0,n.jsxs)("section",{className:"rk-panel rk-notation",children:[(0,n.jsxs)("button",{className:"rk-notation-toggle",onClick:()=>N(e=>!e),children:[(0,n.jsx)("span",{className:"rk-panel-label",children:"Notation Guide"}),(0,n.jsx)("span",{className:"rk-chevron",style:{transform:w?"rotate(180deg)":"rotate(0deg)"},children:"▾"})]}),w&&(0,n.jsxs)("div",{className:"rk-notation-body",children:[(0,n.jsx)("div",{className:"rk-notation-grid",children:x.map(e=>(0,n.jsxs)("div",{className:"rk-notation-chip",style:{"--nc":e.color},children:[(0,n.jsx)("span",{className:"rk-nk",children:e.key}),(0,n.jsx)("span",{className:"rk-nl",children:e.label})]},e.key))}),(0,n.jsxs)("div",{className:"rk-notation-mods",children:[(0,n.jsxs)("div",{className:"rk-mod-chip",children:[(0,n.jsx)("code",{children:"R"})," ",(0,n.jsx)("span",{children:"= 90\xb0 clockwise"})]}),(0,n.jsxs)("div",{className:"rk-mod-chip",children:[(0,n.jsx)("code",{children:"R'"})," ",(0,n.jsx)("span",{children:"= 90\xb0 counter-clockwise"})]}),(0,n.jsxs)("div",{className:"rk-mod-chip",children:[(0,n.jsx)("code",{children:"R2"})," ",(0,n.jsx)("span",{children:"= 180\xb0 turn"})]})]})]})]})]})]}),(0,n.jsxs)("footer",{className:"rk-footer",children:[(0,n.jsx)("strong",{children:"EisatoponAI"}),"\xa0\xb7\xa0 Your Daily Experience of Math Adventures"]}),(0,n.jsx)("style",{children:`
      ...
      `})]})}}},e=>{e.O(0,[8441,3794,7358],()=>e(e.s=4373)),_N_E=e.O()}]);