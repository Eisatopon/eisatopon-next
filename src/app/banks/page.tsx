...
const banks = [
  {
    ...
    description: "General Lyceum • EPAL • Repeat Exams • Overseas Greeks",
    stats: [{ label: "Years", value: "43" }, { label: "Problems", value: "1000+" }, { label: "Types", value: "4" }],
  ...
  },
  {
    ...
    description: "Thales • Euclid • Archimedes",
    stats: [{ label: "Competitions", value: "3" }, { label: "Years", value: "30+" }, { label: "Problems", value: "500+" }],
  ...
  },
  {
    ...
    description: "All problems since the very first edition",
    stats: [{ label: "Years", value: "65+" }, { label: "Problems", value: "390+" }, { label: "Countries", value: "100+" }],
  ...
  },
  {
    ...
    subtitle: "National & Regional Olympiads",
    description: "National • Regional • TST — World Archives",
    stats: [{ label: "Olympiads", value: "20+" }, { label: "Countries", value: "15+" }, { label: "Problems", value: "4000+" }],
      ...
      <section className="relative w-full overflow-hidden bg-gradient-to-br from-[#0a0c10] via-[#0b1628] to-[#0a0c10]">
        ...
        <div className="relative z-10 mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 max-w-[1200px] text-center">
          ...
          <h1 className="font-playfair text-[clamp(2rem,5vw,3.5rem)] font-bold leading-tight mb-4">
            Problem <span className="text-gold">Banks</span>
          </h1>
          <p className="text-ink-tertiary text-lg md:text-xl max-w-2xl mx-auto">
            Collections of mathematics problems from exams and olympiads — local and international
          </p>
        </div>
      </section>
