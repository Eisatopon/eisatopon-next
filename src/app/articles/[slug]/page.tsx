        ...
        >
          ...
          <div
            style={{
              ...
              inset: 0,
              backgroundImage:
                "linear-gradient(rgba(127,168,212,1) 1px,transparent 1px),linear-gradient(90deg,rgba(127,168,212,1) 1px,transparent 1px)",
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                "linear-gradient(to top, rgba(8,10,15,0.97) 0%, rgba(8,10,15,0.5) 55%, transparent 100%)",
              display: "flex",
